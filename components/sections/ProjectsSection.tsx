...
export const ProjectsSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 left-0 w-96 h-96 rounded-full bg-primary/5 blur-[120px] fx-blob fx-vector" />
      <div className="absolute bottom-1/4 right-0 w-80 h-80 rounded-full bg-accent/5 blur-[120px] fx-blob fx-vector" />
